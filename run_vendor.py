...
load_dotenv()
# The review layer's INFO lines are the token-budget evidence (exact prompt
# size, model-call limit) needed to diagnose a self-hosted-model run; everything
# else stays at WARNING so third-party libraries don't flood the output.
